...
| A11Y-PERF-001 | IN_PROGRESS | Автоматический axe/Lighthouse gate | Все публичные маршруты проверяются на WCAG AA, клавиатуру, tap targets, overflow, reduced motion, LCP/CLS; Lighthouse Performance ≥90 на целевом окружении | Codex GPT-5 `/root`; `codex/a11y-perf`, worktree `ashyq-a11y-perf` |
