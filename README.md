...
Перед работой нескольких ИИ обязательно прочитайте [HANDOFF.md](./HANDOFF.md):
там находятся актуальный контекст, реестр задач, владельцы веток и протокол,
который не даёт двум агентам одновременно выполнять одну задачу.
